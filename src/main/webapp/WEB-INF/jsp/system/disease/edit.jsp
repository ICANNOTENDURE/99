					...
					<div class="row">
						...
						<form action="disease/saveOrUpdate.do" name="form" id="form" method="post">
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								<tr>
									<td style="width:79px;text-align: right;padding-top: 13px;">代码:</td>
									<td><input type="text" name="diseaseCode"  value="${pd.diseaseCode}" placeholder="这里输入账号" title="账号" style="width:98%;" /></td>
								</tr>
								<tr>
									<td style="width:79px;text-align: right;padding-top: 13px;">名称:</td>
										<td><input type="text" name="diseaseName" id="name" value="${pd.diseaseName}" placeholder="这里输入账号" title="账号" style="width:98%;" /></td>
								</tr>
								<tr>
									<td style="width:79px;text-align: right;padding-top: 13px;">状态:</td>
									<td>
										<select name="diseaseStatus" title="状态">
...
<script type="text/javascript">
	...
	function hasU(){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>disease/checkName.do?name='+name,
			dataType:'json',
			cache: false,
